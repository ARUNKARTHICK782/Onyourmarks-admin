  ...
  Widget build(BuildContext context) {
    return Scaffold(
                            ...
                            title: Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(snapshot.data?.elementAt(index).name ?? " ",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w600),),
                                    SizedBox(height: 20,),
                                      ...
                                      Navigator.push(context, MaterialPageRoute(
                                          builder: (context) =>
                                              AddTeacher(true,
                                                ...
                                                degree: snapshot.data?.elementAt(index).degree ?? "",
                                                email: snapshot.data?.elementAt(index).email ?? "",
                                                status: snapshot.data?.elementAt(index).status ?? "",
                                                dob:snapshot.data?.elementAt(index).dob ?? "",
                                                gender:snapshot.data?.elementAt(index).gender ?? "",
                                                salary: snapshot.data?.elementAt(index).salary ?? "",
                                                phNo: snapshot.data?.elementAt(index).phoneNo ?? "",
                                                curAdd: snapshot.data?.elementAt(index).currentAddress ?? "",
                                                perAdd: snapshot.data?.elementAt(index).permanentAddress ?? "",
                                                mt: snapshot.data?.elementAt(index).motherTongue ?? "",
                                                bg: snapshot.data?.elementAt(index).bloogGroup ?? "",
                                              )));
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>AddTeacher(false,"",perAdd: '', salary: '', curAdd: '', gender: '', bg: '', name: '', degree: '', dob: '', phNo: '', email: '', mt: '', status: '',)));
        },
