...
class _CoCurricularPageState extends State<CoCurricularPage> {
        ...
        return  AnimatedSize(
          ...
          child: Container(
            ...
            child: GestureDetector(
              child: Card(
                elevation: 2,
                color: (_selectedCardIndex == ind)?Colors.green:Colors.grey.shade400,
  ...
  getAllCCA() async{
    ...
    for (var value in await getCCA()) {
      ...
      if(cca.keys.any((element) => value.std_name.toString().contains(element))){
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child:(allCCA.isEmpty)?Center(child: Text("No CCA's to display"),): ListView.builder(
                          shrinkWrap: true,
                          ...
                          return GestureDetector(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text("Student Name : "+ (allCCA.elementAt(index).student?.name ?? " ")),
                                              Text("Class : "+allCCA.elementAt(index).std_name.toString()),
                                              Text("Roll No : "+(allCCA.elementAt(index).student?.roll_no ?? " ")),
                                            ],
                                          ),
                                        ),
                                      ),
                                      Expanded(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text("Activity Name : "+allCCA.elementAt(index).activity_name.toString()),
                                              Text("Activity Type : "+allCCA.elementAt(index).activity_type.toString())
                                            ],
                                          ),
                                        ),
                                      ),
                                      Expanded(
                                        ...
                                        padding: EdgeInsets.all(10),
                                            child: (
                                                allCCA.elementAt(index).isVerified == "accepted")
                                                  ?Icon(CupertinoIcons.checkmark_alt_circle_fill,color: Colors.green,)
                                                  :(allCCA.elementAt(index).isVerified == "pending")
                                                      ?Icon(CupertinoIcons.exclamationmark,color: Colors.red,)
                                                      :Icon(CupertinoIcons.xmark_circle_fill,color: Colors.redAccent,),
                                      ))
                                    ],
                                  ),
                                ),
                            ...
                            onTap: (){
                              showDialog(context: context, builder: (BuildContext context){
                                return CoCurricularDecisionPage(cca: allCCA.elementAt(index));
                              }).then((value) {
                                initState();
                              });
                            },
...
class CoCurricularDecisionPage extends StatefulWidget {
  ...
  const CoCurricularDecisionPage({Key? key,required this.cca}) : super(key: key);

  @override
  State<CoCurricularDecisionPage> createState() => _CoCurricularDecisionPageState();
}
                                ...
                                child: Container(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text("Roll No : ",style: _getTextStyle(),),
                                      Text("Class : ",style: _getTextStyle(),),
                                      Text("Section : ",style: _getTextStyle(),),
                                      Text("Event Type : ",style: _getTextStyle(),),
                                      Text("Activity Name : ",style: _getTextStyle(),),
                                      Text("Starting Date : ",style: _getTextStyle(),),
                                      Text("Ending Date : ",style: _getTextStyle(),),
                                      Text("Status : ",style: _getTextStyle(),),
                                    ],
                                  ),
                                ),
                              ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          child:
                              ElevatedButton(onPressed: () async{
                                await updateCCA(widget.cca.id ?? " ", "rejected").then((value){
                                  Navigator.pop(context);
                                });
                        ...
                        Flexible(
                            child: ElevatedButton(onPressed: () async{
                              await updateCCA(widget.cca.id ?? " ", "accepted").then((value) {
                                Navigator.pop(context);
                              });
                            }, child: Text("Approve"),style: ElevatedButton.styleFrom(primary: Colors.green),)),
                      ],
                        ),
                      )
                    ],
